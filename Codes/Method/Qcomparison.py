...
def QComp(f1, f2, n):
    ...
    ax1.loglog(w1, weak, c='b', lw='3', ls='--', label = 'Weak-motion Data used')
    ax1.loglog(w1, strong, c='red', lw='3', ls='--', label = 'combination of data sets')
    ax1.loglog(w1, ghassemi, c='orange', lw='3', ls='--', label = 'Previous studies-"Ghassemi et al"')
